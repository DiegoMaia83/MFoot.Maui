...
namespace MFoot.Maui.Aplicacao
{
    ...
    {
        public IEnumerable<CampeonatoPartida> ListarPartidas()
        {
            var listaPartidas = new List<CampeonatoPartida>();
            ...
            listaPartidas.Add(new CampeonatoPartida { Id = 1, TimeCasa = time2, TimeVisitante = time1 });
